...
public class Software_webview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_companies_view);

        new Handler().postDelayed(() -> {

            findViewById(R.id.progress).setVisibility(View.INVISIBLE);
            findViewById(R.id.webview_soft).setVisibility(View.VISIBLE);
        }, 1500);
        ...
        webView=findViewById(R.id.webview_soft);
    ...
    public void onBackPressed() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(Software_webview.this);
