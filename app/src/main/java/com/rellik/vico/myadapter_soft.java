...
import com.rellik.vico.WebViews.Software_webview;

import java.util.ArrayList;


public class myadapter_soft extends RecyclerView.Adapter<myviewholder>  {
    ...
    public myadapter_soft(ArrayList<Model> data, Context context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final myviewholder holder, int position) {
        ...
        holder.ClickHere.setOnClickListener(v -> {
            ...
            Intent i1 = new Intent(context, Software_webview.class);
